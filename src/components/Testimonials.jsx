...
const Testimonials = () => {
  return (
    <div id="testimonials" className='mt-20 tracking-wide'>
        <h2 className='text-3xl sm:text-5xl lg:text-6xl text-center my-8 lg:my-20'>What people are saying?</h2>
        <div className='flex flex-wrap justify-center'>
            {testimonials.map((testimonial, index) =>
            (
                <div key={index} className='w-full sm:w-1/2 lg:w-1/3 px-4 py-2'>
                    <div className='bg-neutral-800 p-6 rounded-md text-md border border-neutral-700 font-thin'>
