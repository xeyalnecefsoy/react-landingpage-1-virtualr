  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
        ...
        <div className="flex mt-10 justify-center">
            <video src={video1} autoPlay loop muted className="w-1/2 rounded-lg border border-orange-700 shadow-orange-400 mx-2 my-4" >
                <source src={video1} type="video/mp4" />
                Your browser does not support the video tag.
            </video>
            <video src={video2} autoPlay loop muted className="w-1/2 rounded-lg border border-orange-700 shadow-orange-400 mx-2 my-4" >
